...
from etl.process_file.users_file.user_model import User, placeholder_not_specified_user
...
def load_users(db_session, users_df: pd.DataFrame):
    ...
    handle_dataframe_missing_mandatory_values(df=users_df, prefix_filename="users_file")
